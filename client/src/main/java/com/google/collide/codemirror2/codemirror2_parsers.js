 ...
 */
  CodeMirror.defineMode("javascript", function (n, j) {
    ...
    var E = n.indentUnit, O = j.json, J = function () {
      ...
      var e = f("keyword a"), a = f("keyword b"), b = f("keyword c"), c = f("operator"), z = {
        type: "atom",
        style: "atom"
      };
      return {
    ...
    }(), H = /[+\-*&%=<>!?|]/, F, K, x = {atom: !0, number: !0, variable: !0, string: !0, regexp: !0}, y = {
      state: null,
      column: null,
      marked: null,
      cc: null
    }, f = {name: "this", next: {name: "arguments"}};
    h.lex = !0;
    return {
      startState: function (f) {
        return {
          ...
          kwAllowed: !0,
          cc: [],
          lexical: new q((f || 0) - E, 0, "block", !1),
          localVars: j.localVars,
          context: j.localVars && {vars: j.localVars},
          indented: 0
        }
      }, token: function (f, e) {
  ...
  CodeMirror.defineMode("xml", function (n, j) {
    ...
    var i = n.indentUnit, o = j.htmlMode ? {
      autoSelfClosers: {
        area: !0,
        base: !0,
        br: !0,
        ...
        track: !0,
        wbr: !0
      }, doNotIndent: {pre: !0}, allowUnquoted: !0, allowMissing: !1
    } : {autoSelfClosers: {}, doNotIndent: {}, allowUnquoted: !1, allowMissing: !1}, p = j.alignCDATA, v, D, A, B;
    return {
      startState: function () {
  ...
  CodeMirror.defineMode("htmlmixed", function (n) {
    ...
    var u = CodeMirror.getMode(n, {
      name: "xml",
      htmlMode: !0
    }), r = CodeMirror.getMode(n, "javascript"), q = CodeMirror.getMode(n, "css");
    return {
      startState: function () {
        var c = u.startState();
        return {
          token: j, localState: null, mode: "html",
          htmlState: c
        }
  ...
  CodeMirror.defineMode("python", function (n, j) {
    ...
    var c = /^[\+\-\*/%&|\^~<>!]/, a = /^[\(\)\[\]\{\}@,:`=;\.]/, b = /^((==)|(!=)|(<=)|(>=)|(<>)|(<<)|(>>)|(\/\/)|(\*\*))/, w = /^((\+=)|(\-=)|(\*=)|(%=)|(\/=)|(&=)|(\|=)|(\^=))/, m = /^((\/\/=)|(>>=)|(<<=)|(\*\*=))/, s = /^[_A-Za-z][_A-Za-z0-9]*/, h = g(["and", "or", "not", "is", "in"]), k = "as assert break class continue def del elif else except finally for from global if import lambda pass raise return try while with yield".split(" "),
      i = "abs all any bin bool bytearray callable chr classmethod compile complex delattr dict dir divmod enumerate eval filter float format frozenset getattr globals hasattr hash help hex id input int isinstance issubclass iter len list locals map max memoryview min next object oct open ord pow property range repr reversed round set setattr slice sorted staticmethod str sum super tuple type vars zip __import__ NotImplemented Ellipsis __debug__".split(" "), o = {
        builtins: "apply basestring buffer cmp coerce execfile file intern long raw_input reduce reload unichr unicode xrange False True None".split(" "),
        keywords: ["exec", "print"]
      }, p = {builtins: ["ascii", "bytes", "exec", "print"], keywords: ["nonlocal", "False", "True", "None"]};
    ...
    return k = {
      startState: function (b) {
        return {tokenize: d, scopes: [{offset: b || 0, type: "py"}], lastToken: null, lambda: !1, dedent: 0}
      }, token: function (b,
                          a) {
        var c = q(b, a);
  ...
  CodeMirror.defineMode("dart", function (n) {
    ...
    var E = n.indentUnit, O = function () {
      ...
      var b = a("keyword a"), c = a("keyword b"), e = a("keyword c"), d = a("operator"), i = {
        type: "atom",
        style: "atom"
      }, h = i;
      return {
      ...
      string: !0,
      regexp: !0
    }, x = {state: null, column: null, marked: null, cc: null}, y = {name: "this", next: {name: "arguments"}};
    k.lex = !0;
    return {
    ...
    CodeMirror.defineMIME("text/x-csrc",
      {
        name: "clike",
        keywords: n(d),
        blockKeywords: n("case do else for if switch while struct"),
        atoms: n("null"),
        hooks: {"#": j}
      });
    CodeMirror.defineMIME("text/x-c++src", {
      name: "clike",
      keywords: n(d + " asm dynamic_cast namespace reinterpret_cast try bool explicit new static_cast typeid catch operator template typename class friend private this using const_cast inline public throw virtual delete mutable protected wchar_t"),
      blockKeywords: n("catch class do else finally for if struct switch try while"),
      atoms: n("true false null"),
      hooks: {"#": j}
    });
    CodeMirror.defineMIME("text/x-java", {
      name: "clike",
      keywords: n("abstract assert boolean break byte case catch char class const continue default do double else enum extends final finally float for goto if implements import instanceof int interface long native new package private protected public return short static strictfp super switch synchronized this throw throws transient try void volatile while"),
      blockKeywords: n("catch class do else finally for if switch try while"),
      atoms: n("true false null"),
      hooks: {
        "@": function (d) {
          d.eatWhile(/[\w\$_]/);
  ...
  (function () {
    ...
    var g = {
      name: "clike",
      keywords: n("abstract and array as break case catch class clone const continue declare default do else elseif enddeclare endfor endforeach endif endswitch endwhile extends final for foreach function global goto if implements interface instanceof namespace new or private protected public static switch throw trait try use var while xor die echo empty exit eval include include_once isset list require require_once return print unset __halt_compiler self static parent"),
      blockKeywords: n("catch do else elseif for foreach if switch try while"),
      atoms: n("true false null TRUE FALSE NULL"),
      multiLineStrings: !0,
      hooks: {
        $: function (d) {
          d.eatWhile(/[\w\$_]/);
      ...
      function (d, j) {
        function n(b, d) {
          ...
          if (d.curMode == r) {
            ...
            -1 != h ? (d.pending = "string" == g && /\"$/.test(j) && !/\?>/.test(j) ? '"' : {
              end: b.pos,
              style: g
            }, b.backUp(j.length -
        ...
        var r = CodeMirror.getMode(d, {
          name: "xml",
          htmlMode: !0
        }), q = CodeMirror.getMode(d, "javascript"), c = CodeMirror.getMode(d, "css"), a = CodeMirror.getMode(d, g);
        return {
          startState: function () {
            var b = r.startState();
            return {
              html: b,
              php: a.startState(),
              curMode: j.startOpen ? a : r,
              curState: j.startOpen ? a.startState() : b,
              curClose: j.startOpen ? /^\?>/ : null,
              mode: j.startOpen ? "php" : "html",
              pending: null
            }

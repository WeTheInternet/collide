...
public class JsWindow extends JsElementalMixinBase  implements Window {
  ...
  public final native BeforeUnloadEventListener getOnbeforeunload() /*-{
    // Copied from JsEventTarget.
    return this.onbeforeunload && this.onbeforeunload.listener;
  }-*/;

  public final native void setOnbeforeunload(BeforeUnloadEventListener listener) /*-{
    if (listener == null) {
    ...
    handler = $entry(function(event) {
      return listener.@elemental.html.Window.BeforeUnloadEventListener::handleEvent(Lelemental/events/Event;)(event);
    });
  ...
  public final native JsMediaStream newMediaStream(MediaStreamTrackList audioTracks, MediaStreamTrackList videoTracks) /*-{ return new webkitMediaStream(audioTracks, videoTracks); }-*/;
  ...
  public final native JsPeerConnection00 newPeerConnection00(String serverConfiguration, IceCallback iceCallback) /*-{ return new webkitPeerConnection00(serverConfiguration, $entry(iceCallback.@elemental.html.IceCallback::onIceCallback(Lelemental/html/IceCandidate;ZLelemental/html/PeerConnection00;)).bind(iceCallback)); }-*/;

  public final native JsSessionDescription newSessionDescription(String sdp) /*-{ return new SessionDescription(sdp); }-*/;

  public final native JsShadowRoot newShadowRoot(Element host) /*-{ return new WebKitShadowRoot(host); }-*/;
  ...
  public final native JsWebSocket newWebSocket(String url) /*-{ return new WebSocket(url); }-*/;

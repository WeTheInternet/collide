...
public class PanelHeader extends CompositeView<PanelController>{
  ...
  public PanelHeader(Resources res, PanelModel model) {
   ...
   */
  public static PanelHeader create(DivElement moduleContainer, Resources res, PanelModel model) {
    PanelHeader mod = new PanelHeader(res, model == null ? PanelModel.newBasicModel().build() : model);
    if (moduleContainer != null)
      moduleContainer.appendChild((DivElement)mod.headerContainer);
    return mod;
  }
